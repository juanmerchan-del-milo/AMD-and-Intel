/* Final 1.26.0 CPU Lab repair layer: one tab controller, expanded history,
   explicit current models, and a reliable way back to the PC builder. */
(() => {
  'use strict';
  window.APP_BUILD = '1.26.0';
  ...
  const text = {
    es:{back:'Volver al constructor 3D',version:'CPU LAB · 1.26.0',historyA:'K8 · DDR/DDR1',historyI:'Prescott · DDR/DDR1'},
    en:{back:'Back to the 3D builder',version:'CPU LAB · 1.26.0',historyA:'K8 · DDR/DDR1',historyI:'Prescott · DDR/DDR1'},
    zh:{back:'返回 3D 装机工具',version:'CPU LAB · 1.26.0',historyA:'K8 · DDR/DDR1',historyI:'Prescott · DDR/DDR1'}
  };
