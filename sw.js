...
'use strict';
const CACHE='pc-lab-builder-1.26.1-r1';
const FILES=[
  './','./index.html','./styles.css','./onboarding.css','./catalog.js','./cpus.js','./catalog-extended.js',
  './i18n.js','./hardware.js','./glossary.js','./engine.js','./viewer.js','./app.js','./onboarding.js',
  './workshop.css','./workshop-data.js','./workshop-components.js','./workshop-lessons.js','./lab-builder-bridge.js','./workshop-models.js','./workshop.js',
