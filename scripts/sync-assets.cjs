...
const files=['index.html','cpu-lab.html','styles.css','catalog.js','cpus.js','catalog-extended.js','i18n.js','hardware.js','glossary.js','engine.js','viewer.js','workshop-data.js','workshop-models.js','workshop.js','workshop.css','app.js','v18-fixes.js','lab-124-fixes.js','pwa.js','sw.js','manifest.webmanifest','desktop/renderer.js','desktop/desktop.css'];
