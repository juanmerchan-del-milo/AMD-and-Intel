...
const files=['index.html','cpu-lab.html','styles.css','onboarding.css','catalog.js','cpus.js','catalog-extended.js','i18n.js','hardware.js','glossary.js','engine.js','viewer.js','workshop-data.js','workshop-components.js','workshop-lessons.js','lab-builder-bridge.js','workshop-models.js','workshop.js','workshop.css','app.js','onboarding.js','v18-fixes.js','lab-124-fixes.js','pwa.js','sw.js','manifest.webmanifest','desktop/renderer.js','desktop/desktop.css'];
